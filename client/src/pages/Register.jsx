      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-400">
            Join ShopSphere to order goods, track deliveries, and write reviews
          </p>
        </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-855 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-primary text-slate-850 dark:text-white"
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-3 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-855 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-primary text-slate-850 dark:text-white"
              />
              <button
                type="button"
